"""
Django settings for findhandy_42543 project.
...
ROOT_URLCONF = 'findhandy_42543.urls'
...
WSGI_APPLICATION = 'findhandy_42543.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "findhandy_42543 API",
    "DESCRIPTION": "API documentation for findhandy_42543 App",
    "VERSION": "v1",
}
